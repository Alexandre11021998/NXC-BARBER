...
async function seedDatabase() {
  try {
    // Números de telefone fictícios para as barbearias
    const phones = [
      ["(11) 1234-5678", "(11) 9876-5432"],
      ["(21) 2345-6789", "(21) 9012-3456"],
      ["(31) 3456-7890", "(31) 6543-2109"],
      ["(41) 4567-0123", "(41) 3210-9876"],
      ["(51) 5678-1234", "(51) 9087-6543"],
      ["(61) 6789-2345", "(61) 6543-0987"],
      ["(71) 7890-3456", "(71) 0987-6543"],
      ["(81) 8901-4567", "(81) 6543-2109"],
      ["(91) 9012-5678", "(91) 3210-9876"],
      ["(99) 9876-1234", "(99) 6543-0987"],
    ]
    const images = [
    ...
    for (let i = 0; i < 10; i++) {
      ...
      const barbershop = await prisma.barbershop.create({
        data: {
          ...
          address,
          imageUrl: imageUrl,
          description: "Descrição padrão para a barbearia.",
